                                ...
                                <div class="tab-pane fade show active" id="overview" role="tabpanel"
                                    ...
                                    <div class="d-flex flex-wrap justify-content-xl-between">
                                        <div
                                            ...
                                            <div class="d-flex flex-column justify-content-around">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    -0 bg-transparent border-0 text-dark shadow-none font-weight-medium"
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex flex-column justify-content-around">
                                                <small class="mb-1 text-muted">Total Wali</small>


                                                <h5 class="me-2 mb-0">{{ $wali }}</h5>
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex flex-column justify-content-around">
                                                <small class="mb-1 text-muted">Bendahara</small>
                                                <h5 class="me-2 mb-0">{{ $bendahara }}</h5>
                                            </div>
                                        </div>
                                        <div
